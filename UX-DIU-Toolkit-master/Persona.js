	...
	.controller("controller", ["$scope", function($scope) { 
		...
		$scope.Personas = [
			{		
                ...
                Contextos: "Necesita una habitacion o apartamento asequible en el centro de Barcelona, de manera urgente",  
				PreferredChannels: [
			...
			{	
                ...
                Contextos:   "Quiere encontrar un piso en buena localización con unos buenos compañeros" ,
				PreferredChannels: [
